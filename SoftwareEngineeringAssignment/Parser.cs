...
namespace SoftwareEngineeringAssignment
{
    public class Parser
    {
        ...
        private Dictionary<string, defineMethod> methodDefinitions = new Dictionary<string, defineMethod>();
        ...
        private void ParseMethodDefinition(string[] lines, ref int currentLineIndex)
        {
            ...
            defineMethod methodDefinition = new defineMethod(methodName, parameters, body);
        ...
        public string InvokeMethod(string line, Dictionary<string, int> globalVariables, int methodStartLineNumber)
        {
            ...
            if (methodDefinitions.TryGetValue(methodName, out defineMethod method))
            {
        ...
        ///  THESE METHODS ARE CONSIDERED REDUNDANT AFTER DEEP REFACTORING
        ///  AS NOW THE APPLICATION USES FACTORY DESIGN PATTERN
